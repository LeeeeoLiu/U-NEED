...
'''
    ...
    for split in ['train', 'dev', 'test']:
        process_file(folder + '/src-{}.txt'.format(split), folder + '/src-{}-id.embed'.format(split), batch_size=8)
        process_file(folder + '/tgt-{}.txt'.format(split), folder + '/tgt-{}-id.embed'.format(split), max_len=30, batch_size=8)
